export const characters = [
  { id: "strider", name: "Rift Strider", tag: "Mobile", description: "Fast movement, better pickup flow, ideal for kiting.", color: "#6be1be", baseStats: { maxHealth: 118, moveSpeed: 250, damageMultiplier: 1.02, cooldownMultiplier: 0.9, pickupRadius: 88, luck: 0.1 }, startingWeapons: ["arcBlades"] },
  { id: "ember", name: "Ember Sage", tag: "Power", description: "Higher damage and faster spell rhythm for snowball builds.", color: "#ff9a76", baseStats: { maxHealth: 108, moveSpeed: 225, damageMultiplier: 1.22, cooldownMultiplier: 0.9, projectileSpeedMultiplier: 1.14, xpMultiplier: 1.04, luck: 0.06 }, startingWeapons: ["emberLance"] },
  { id: "warden", name: "Prism Warden", tag: "Guard", description: "More health, larger area effects, safer frontline play.", color: "#9cc0ff", baseStats: { maxHealth: 146, moveSpeed: 214, damageMultiplier: 1.04, cooldownMultiplier: 0.98, areaMultiplier: 1.16, armor: 0.16, regen: 0.35 }, startingWeapons: ["frostField"] }
];

export const weapons = {
  arcBlades: { id: "arcBlades", name: "Arc Blades", kind: "orbital", color: "#9cf0ff", maxLevel: 5, description: "Orbiting blades that protect the player at close range.", levels: [{ count: 3, radius: 56, size: 11, damage: 18, speed: 2.45 }, { count: 3, radius: 58, size: 12, damage: 23, speed: 2.7 }, { count: 4, radius: 62, size: 13, damage: 28, speed: 2.95 }, { count: 4, radius: 66, size: 13, damage: 34, speed: 3.15 }, { count: 5, radius: 70, size: 14, damage: 42, speed: 3.4 }] },
  emberLance: { id: "emberLance", name: "Ember Lance", kind: "targetedProjectile", color: "#ff9a76", maxLevel: 5, description: "Fires high speed bolts toward the nearest target.", levels: [{ count: 1, cooldown: 0.74, damage: 25, speed: 450, size: 7, life: 1.28 }, { count: 2, cooldown: 0.72, damage: 28, speed: 480, size: 8, life: 1.3 }, { count: 2, cooldown: 0.62, damage: 33, speed: 510, size: 8, life: 1.35 }, { count: 3, cooldown: 0.58, damage: 39, speed: 545, size: 9, life: 1.42 }, { count: 3, cooldown: 0.52, damage: 46, speed: 580, size: 10, life: 1.5 }] },
  ...
  frostField: { id: "frostField", name: "Frost Field", kind: "aura", color: "#8df0ff", maxLevel: 5, description: "Persistent chilling aura around the player.", levels: [{ damage: 10, radius: 86, tick: 0.42, slow: 0.18 }, { damage: 12, radius: 96, tick: 0.38, slow: 0.22 }, { damage: 15, radius: 106, tick: 0.34, slow: 0.26 }, { damage: 19, radius: 118, tick: 0.31, slow: 0.3 }, { damage: 24, radius: 132, tick: 0.28, slow: 0.34 }] }
};
...
export const encounterSchedule = [
  { time: 0, pool: ["crawler"] },
  { time: 32, pool: ["crawler", "sprinter"] },
  { time: 62, pool: ["crawler", "sprinter", "juggernaut"] },
  { time: 96, pool: ["crawler", "sprinter", "juggernaut", "spitter"] },
